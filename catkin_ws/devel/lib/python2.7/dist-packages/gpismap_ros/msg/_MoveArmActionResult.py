...
"""autogenerated by genpy from gpismap_ros/MoveArmActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveArmActionResult(genpy.Message):
  ...
  _type = "gpismap_ros/MoveArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','gpismap_ros/MoveArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = gpismap_ros.msg.MoveArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = gpismap_ros.msg.MoveArmResult()
