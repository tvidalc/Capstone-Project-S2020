...
"""autogenerated by genpy from robot_motion_server/MoveArmActionResult.msg. Do not edit."""
import codecs
import sys
...
class MoveArmActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "robot_motion_server/MoveArmActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_motion_server/MoveArmResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = robot_motion_server.msg.MoveArmResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = robot_motion_server.msg.MoveArmResult()
