...
"""autogenerated by genpy from robot_motion_server/MoveArmActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MoveArmActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "robot_motion_server/MoveArmActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robot_motion_server/MoveArmFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveArmActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robot_motion_server.msg.MoveArmFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robot_motion_server.msg.MoveArmFeedback()
