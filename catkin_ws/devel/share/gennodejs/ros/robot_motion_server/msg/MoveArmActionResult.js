...
let MoveArmResult = require('./MoveArmResult.js');
...
class MoveArmActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveArmResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveArmActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = MoveArmResult.Resolve(msg.result)
    }
    else {
      resolved.result = new MoveArmResult()
    }
...
module.exports = MoveArmActionResult;
