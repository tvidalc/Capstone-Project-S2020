...
let MoveArmGoal = require('./MoveArmGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class MoveArmActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MoveArmGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MoveArmGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveArmActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = MoveArmGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new MoveArmGoal()
    }
...
module.exports = MoveArmActionGoal;
