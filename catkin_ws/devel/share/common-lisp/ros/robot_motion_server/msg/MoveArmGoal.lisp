...
(cl:defmethod cl:initialize-instance :after ((m <MoveArmGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveArmGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_motion_server-msg:<MoveArmGoal> is deprecated: use robot_motion_server-msg:MoveArmGoal instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <MoveArmGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_motion_server-msg:command-val is deprecated.  Use robot_motion_server-msg:command instead.")
  (command m))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <MoveArmGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_motion_server-msg:target_pose-val is deprecated.  Use robot_motion_server-msg:target_pose instead.")
  (target_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveArmGoal>)))
  ...
  "robot_motion_server/MoveArmGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveArmGoal)))
  "Returns string type for a message object of type 'MoveArmGoal"
  "robot_motion_server/MoveArmGoal")
