...
#define DEFAULT_TREE_MAX_HALFLENGTH       102.4  //102.4 // 0.05*2^10
#define DEFAULT_TREE_CLUSTER_HALFLENGTH   0.2   // 0.05*2^2
...
#define GPISMAP_SENSOR_OFFSET_0   0.0 //0.08  // the hokuyo sensor position (0.08, 0) on a turtlebot for simulation
...
#define GPISMAP3_MIN_RANGE   3e-1
