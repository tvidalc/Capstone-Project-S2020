...
namespace gp
{
    ...
    public:
        ...
        Node3(Point3<float> _pos, float _val, float _pose_sig, Point3<float> _grad, float _grad_sig,
              NODE_TYPE n = NODE_TYPE::NONE);
        ...
        void
        updateData(float _val, float _pose_sig, Point3<float> _grad, float _grad_sig, NODE_TYPE n = NODE_TYPE::NONE);
