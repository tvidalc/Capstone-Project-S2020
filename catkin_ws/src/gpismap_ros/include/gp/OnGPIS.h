...
namespace gp
{
    ...
    public:
        ...
        void test2Dpoint(const EVectorX &xt, float &val, float &gradx, float &grady, float &varval, float &vargradx,
                         float &vargrady);

        void test2Dpoint(float x, float y, float &val, float &gradx, float &grady, float &varval, float &vargradx,
                         float &vargrady);
    };
