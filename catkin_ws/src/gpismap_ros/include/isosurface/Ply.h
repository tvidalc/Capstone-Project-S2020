...
namespace isosurface
{
    ...
    public:
        ...
        operator Point3D<Real2>() const { return Point3D<Real2>(point); }
    ...
    public:
        ...
        template<class Real2>
        operator Point2D<Real2>() const { return Point2D<Real2>(point); }
    ...
    public:
        //////////////////////////
        // Vector space methods //
        void Add(const PlyTextureVertex &p) {
            point += p.point;
            texture += p.texture;
        }
    ...
    PlyProperty PlyTextureVertex<double>::ReadProperties[] =
            {
                    ...
                    {"y",         PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       point.coords[1])),                     0, 0, 0, 0},
                    {"z",         PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       point.coords[2])),                     0, 0, 0, 0},
                    {"u",         PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       texture.coords[0])),                   0, 0, 0, 0},
                    {"v",         PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       texture.coords[1])),                   0, 0, 0, 0},
                    {"texture_u", PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       texture.coords[0])),                   0, 0, 0, 0},
                    {"texture_v", PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyTextureVertex,
                                                                       texture.coords[1])),                   0, 0, 0, 0},
            };
    template<>
    ...
    public:
        //////////////////////////
        // Vector space methods //
        void Add(const PlyValueVertex &p) {
            point += p.point;
            value += p.value;
        }
        ...
        PlyValueVertex(void) {
            point.coords[0] = point.coords[1] = point.coords[2] = 0;
            value = 0;
        }
    ...
    public:
        ...
        //////////////////////////
        // Vector space methods //
        void Add(const PlyOrientedVertex &p) {
            point += p.point;
            normal += p.normal;
        }
        ...
        PlyOrientedVertex(
                void) { point.coords[0] = point.coords[1] = point.coords[2] = normal.coords[0] = normal.coords[1] = normal.coords[2] = 0; }
    ...
    */
    ...
    public:
        //////////////////////////
        // Vector space methods //
        void Add(const PlyColorVertex &p) {
            point += p.point;
            color += p.color;
        }
        ...
        PlyColorVertex(
                void) { point.coords[0] = point.coords[1] = point.coords[2] = 0, color.coords[0] = color.coords[1] = color.coords[2] = 0; }
    ...
    PlyProperty PlyColorVertex<double>::ReadProperties[] =
            {
                    {"x",             PLY_DOUBLE, PLY_DOUBLE, int(
                            offsetof(PlyColorVertex, point.coords[0])),                                       0, 0, 0, 0},
                    {"y",             PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           point.coords[1])),                 0, 0, 0, 0},
                    {"z",             PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           point.coords[2])),                 0, 0, 0, 0},
                    {"red",           PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[0])),                 0, 0, 0, 0},
                    {"green",         PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[1])),                 0, 0, 0, 0},
                    {"blue",          PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[2])),                 0, 0, 0, 0},
                    {"diffuse_red",   PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[0])),                 0, 0, 0, 0},
                    {"diffuse_green", PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[1])),                 0, 0, 0, 0},
                    {"diffuse_blue",  PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex,
                                                                           color.coords[2])),                 0, 0, 0, 0},
            };
    template<>
    ...
    public:
        //////////////////////////
        // Vector space methods //
        void Add(const PlyColorVertex2D &p) {
            point += p.point;
            color += p.color;
        }
        ...
        PlyColorVertex2D(
                void) { point.coords[0] = point.coords[1] = 0, color.coords[0] = color.coords[1] = color.coords[2] = 0; }
    ...
    PlyProperty PlyColorVertex2D<float>::ReadProperties[] =
            {
                    {"x",             PLY_FLOAT, PLY_FLOAT, int(
                            offsetof(PlyColorVertex2D, point.coords[0])),                                     0, 0, 0, 0},
                    {"y",             PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         point.coords[1])),                   0, 0, 0, 0},
                    {"red",           PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[0])),                   0, 0, 0, 0},
                    {"green",         PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[1])),                   0, 0, 0, 0},
                    {"blue",          PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[2])),                   0, 0, 0, 0},
                    {"diffuse_red",   PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[0])),                   0, 0, 0, 0},
                    {"diffuse_green", PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[1])),                   0, 0, 0, 0},
                    {"diffuse_blue",  PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyColorVertex2D,
                                                                         color.coords[2])),                   0, 0, 0, 0},
            };
    template<>
    ...
    PlyProperty PlyColorVertex2D<double>::ReadProperties[] =
            {
                    {"x",             PLY_DOUBLE, PLY_DOUBLE, int(
                            offsetof(PlyColorVertex2D, point.coords[0])),                                       0, 0, 0, 0},
                    {"y",             PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           point.coords[1])),                   0, 0, 0, 0},
                    {"red",           PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[0])),                   0, 0, 0, 0},
                    {"green",         PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[1])),                   0, 0, 0, 0},
                    {"blue",          PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[2])),                   0, 0, 0, 0},
                    {"diffuse_red",   PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[0])),                   0, 0, 0, 0},
                    {"diffuse_green", PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[1])),                   0, 0, 0, 0},
                    {"diffuse_blue",  PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyColorVertex2D,
                                                                           color.coords[2])),                   0, 0, 0, 0},
            };
    template<>
    ...
    public:
        //////////////////////////
        // Vector space methods //
        void Add(const PlyOrientedColorVertex &p) {
            point += p.point;
            normal += p.normal;
            color += p.color;
        }
        ...
        PlyOrientedColorVertex(
                void) { point.coords[0] = point.coords[1] = point.coords[2] = normal.coords[0] = normal.coords[1] = normal.coords[2] = 0, color.coords[0] = color.coords[1] = color.coords[2] = 0; }
    ...
    PlyProperty PlyOrientedColorVertex<float>::ReadProperties[] =
            {
                    {"x",             PLY_FLOAT, PLY_FLOAT, int(
                            offsetof(PlyOrientedColorVertex, point.coords[0])),                                      0, 0, 0, 0},
                    {"y",             PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         point.coords[1])),                          0, 0, 0, 0},
                    {"z",             PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         point.coords[2])),                          0, 0, 0, 0},
                    {"nx",            PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         normal.coords[0])),                         0, 0, 0, 0},
                    {"ny",            PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         normal.coords[1])),                         0, 0, 0, 0},
                    {"nz",            PLY_FLOAT, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         normal.coords[2])),                         0, 0, 0, 0},
                    {"red",           PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[0])),                          0, 0, 0, 0},
                    {"green",         PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[1])),                          0, 0, 0, 0},
                    {"blue",          PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[2])),                          0, 0, 0, 0},
                    {"diffuse_red",   PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[0])),                          0, 0, 0, 0},
                    {"diffuse_green", PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[1])),                          0, 0, 0, 0},
                    {"diffuse_blue",  PLY_UCHAR, PLY_FLOAT, int(offsetof(PlyOrientedColorVertex,
                                                                         color.coords[2])),                          0, 0, 0, 0}
            };
    template<>
    ...
    PlyProperty PlyOrientedColorVertex<double>::ReadProperties[] =
            {
                    {"x",             PLY_DOUBLE, PLY_DOUBLE, int(
                            offsetof(PlyOrientedColorVertex, point.coords[0])),                                        0, 0, 0, 0},
                    {"y",             PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           point.coords[1])),                          0, 0, 0, 0},
                    {"z",             PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           point.coords[2])),                          0, 0, 0, 0},
                    {"nx",            PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           normal.coords[0])),                         0, 0, 0, 0},
                    {"ny",            PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           normal.coords[1])),                         0, 0, 0, 0},
                    {"nz",            PLY_DOUBLE, PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           normal.coords[2])),                         0, 0, 0, 0},
                    {"red",           PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[0])),                          0, 0, 0, 0},
                    {"green",         PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[1])),                          0, 0, 0, 0},
                    {"blue",          PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[2])),                          0, 0, 0, 0},
                    {"diffuse_red",   PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[0])),                          0, 0, 0, 0},
                    {"diffuse_green", PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[1])),                          0, 0, 0, 0},
                    {"diffuse_blue",  PLY_UCHAR,  PLY_DOUBLE, int(offsetof(PlyOrientedColorVertex,
                                                                           color.coords[2])),                          0, 0, 0, 0}
            };
    template<>
    ...
    PlyProperty PlyVFFace<float>::ReadProperties[] =
            {
                    {"vertex_indices", PLY_INT,   PLY_INT, offsetof(PlyVFFace,
                                                                    vertices),                       1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyVFFace, nr_vertices)},
                    {"vx",             PLY_FLOAT, PLY_FLOAT, (int) offsetof(PlyVFFace,
                                                                            v.coords[0]),            0, 0, 0,             0},
                    {"vy",             PLY_FLOAT, PLY_FLOAT, (int) offsetof(PlyVFFace,
                                                                            v.coords[1]),            0, 0, 0,             0},
                    {"vz",             PLY_FLOAT, PLY_FLOAT, (int) offsetof(PlyVFFace,
                                                                            v.coords[2]),            0, 0, 0,             0},
            };
    template<>
    PlyProperty PlyVFFace<double>::ReadProperties[] =
            {
                    {"vertex_indices", PLY_INT,    PLY_INT,    (int) offsetof(PlyVFFace,
                                                                              vertices),               1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyVFFace, nr_vertices)},
                    {"vx",             PLY_DOUBLE, PLY_DOUBLE, (int) offsetof(PlyVFFace,
                                                                              v.coords[0]),            0, 0, 0,             0},
                    {"vy",             PLY_DOUBLE, PLY_DOUBLE, (int) offsetof(PlyVFFace,
                                                                              v.coords[1]),            0, 0, 0,             0},
                    {"vz",             PLY_DOUBLE, PLY_DOUBLE, (int) offsetof(PlyVFFace,
                                                                              v.coords[2]),            0, 0, 0,             0},
            };
    template<>
    ...
    struct PlyTexturedFace {
        ...
        Point2D<Real> texture(int idx) const {
            return Point2D<Real>(uv_coordinates[2 * idx], uv_coordinates[2 * idx + 1]);
        }
    ...
    PlyProperty PlyTexturedFace<float>::ReadProperties[] =
            {
                    {"vertex_indices", PLY_INT,   PLY_INT, offsetof(PlyTexturedFace,
                                                                    vertices),                                1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyTexturedFace, nr_vertices)},
                    {"texcoord",       PLY_FLOAT, PLY_FLOAT, (int) offsetof(PlyTexturedFace,
                                                                            uv_coordinates),                  1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyTexturedFace, nr_uv_coordinates)},
            };
    template<>
    PlyProperty PlyTexturedFace<double>::ReadProperties[] =
            {
                    {"vertex_indices", PLY_INT,    PLY_INT, offsetof(PlyTexturedFace,
                                                                     vertices),                                 1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyTexturedFace, nr_vertices)},
                    {"texcoord",       PLY_DOUBLE, PLY_DOUBLE, (int) offsetof(PlyTexturedFace,
                                                                              uv_coordinates),                  1, PLY_INT, PLY_INT, (int) offsetof(
                            PlyTexturedFace, nr_uv_coordinates)},
            };
    template<>
    ...
    int PlyWriteColorTriangles(const char *fileName,
                               const std::vector<Vertex> &vertices,
                               const std::vector<std::pair<TriangleIndex, Point3D<float> > > &triangles,
                               PlyProperty *properties, int propertyNum,
                               int file_type,
                               char **comments = NULL, const int &commentNum = 0);
    ...
    template<class Vertex>
    int MWriteTriangles(const char *fileName, const std::vector<Vertex> &vertices,
