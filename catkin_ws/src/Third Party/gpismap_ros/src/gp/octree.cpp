...
static float sqdist(const gp::Point3<float>& pt1, const gp::Point3<float>& pt2)
{
...
namespace gp
{
    ...
    bool OcTree::Insert(std::shared_ptr <Node3> n) {
        ...
        if (northWestFront->Insert(n)) {
            updateCount();
            return true;
        }
        if (northEastFront->Insert(n)) {
            updateCount();
            return true;
        }
        if (southWestFront->Insert(n)) {
            updateCount();
            return true;
        }
        if (southEastFront->Insert(n)) {
            updateCount();
            return true;
        }
        if (northWestBack->Insert(n)) {
            updateCount();
            return true;
        }
        if (northEastBack->Insert(n)) {
            updateCount();
            return true;
        }
        if (southWestBack->Insert(n)) {
            updateCount();
            return true;
        }
        if (southEastBack->Insert(n)) {
            updateCount();
            return true;
        }
